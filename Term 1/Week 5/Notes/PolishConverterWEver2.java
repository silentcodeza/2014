...
public class PolishConverterWEver2
{   public void Polish(String P, String Q) throws Exception
	{	boolean debug = true;
		...
		{	if (debug)
			{	System.out.println("Q ------> "+Q);
				...
				System.out.println(constructOutputForCharacterConsidered(indx, Q));
			}
	...
	public String constructOutputForCharacterConsidered(int pos, String expr)
	{	// create 2 lines that will refer to character
		// under consideration
		String line1 = "";
		String line2 = "";
		for (int i=0; i<pos; i++)
		...
		// construct output to display expression and indexing
		return "\n"+expr+"\n"+line1+"\n"+line2;
	}
		
    public static void main (String[] args) throws Exception
    {   
        PolishConverterWEver2 objct = new PolishConverterWEver2();
